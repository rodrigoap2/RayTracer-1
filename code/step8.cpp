...
int main() {
    ...
    printf("P3\n%i %i\n255\n", nx, ny);
    hitable *list[4];
    list[0] = new sphere(vec3(0, 0.1, -1), 0.5, new lambertian(vec3(0.8, 0.3, 0.3)));
    list[1] = new sphere(vec3(0.0,-100.5,-1.0), 100, new lambertian(vec3(0.8, 0.8, 0.0)));
    list[2] = new sphere(vec3(1,0.1,-1), 0.5, new metal(vec3(0.8, 0.6, 0.2), 0.3));
    list[3] = new sphere(vec3(-1,0.1,-1), 0.5, new metal(vec3(0.8, 0.8, 0.8), 1.0));
